...
public class ChampionQuizActivity extends AppCompatActivity {
  ...
  public void loadLevel() {
    ...
    if (currentLevel <= maxLevel) {
      ...
      loadFinishScreen();
      // What did I think while doing this. This looks exactly like it should be done in separate
      // classes?
      ...
      switch (i) {
        case 0:
          int imageID1 =
              getResources()
                  .getIdentifier(
                      buttonChampionImages[0].toLowerCase(), "drawable", getPackageName());
        ...
        case 1:
          int imageID2 =
              getResources()
                  .getIdentifier(
                      buttonChampionImages[1].toLowerCase(), "drawable", getPackageName());
        ...
        case 2:
          int imageID3 =
              getResources()
                  .getIdentifier(
                      buttonChampionImages[2].toLowerCase(), "drawable", getPackageName());
        ...
        case 3:
          int imageID4 =
              getResources()
                  .getIdentifier(
                      buttonChampionImages[3].toLowerCase(), "drawable", getPackageName());
