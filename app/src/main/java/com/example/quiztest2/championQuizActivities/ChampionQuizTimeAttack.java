...
public class ChampionQuizTimeAttack extends AppCompatActivity {
    ...
    private void setChampionImageResources(String[] championIDArray) {
        for(int i = 0; i<4; i++){
            switch (i){
                case 0:
                    btnAns1.setImageResource(getResources().getIdentifier(championIDArray[0].toLowerCase(), "drawable", getPackageName()));
                case 1:
                    btnAns2.setImageResource(getResources().getIdentifier(championIDArray[1].toLowerCase(), "drawable", getPackageName()));
                case 2:
                    btnAns3.setImageResource(getResources().getIdentifier(championIDArray[2].toLowerCase(), "drawable", getPackageName()));
                case 3:
                    btnAns4.setImageResource(getResources().getIdentifier(championIDArray[3].toLowerCase(), "drawable", getPackageName()));
            }
        }
    }
