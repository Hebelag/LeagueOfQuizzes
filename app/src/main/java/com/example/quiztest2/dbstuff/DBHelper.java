...
// Für den Fall dass ich das ins Internet auslagern will:
// https://stackoverflow.com/questions/11299208/how-to-synchronize-android-database-with-an-online-sql-server
...
public class DBHelper extends SQLiteOpenHelper {
  ...
  public void onCreate(SQLiteDatabase db) {
    ...
    final String SQL_CREATE_CHAMPION_TABLE =
        "CREATE TABLE IF NOT EXISTS "
            ...
            + " TINYTEXT, "
            + ChampionsTable.COLUMN_TITLE
            + " TINYTEXT, "
            + ChampionsTable.COLUMN_LORE
            + " TEXT, "
            + ChampionsTable.COLUMN_PRIM_ROLE
            + " TINYTEXT, "
            + ChampionsTable.COLUMN_SEC_ROLE
            + " TINYTEXT, "
            +
            // ChampionsTable.COLUMN_ORIGIN + " TINYTEXT, " +
            // ChampionsTable.COLUMN_RELEASE_DATE + " CHAR(12), " +
            // ChampionsTable.COLUMN_RANGED + " TINYTEXT, " +
            ChampionsTable.COLUMN_ATTACK
            + " TINYINT, "
            + ChampionsTable.COLUMN_DEFENSE
            + " TINYINT, "
            + ChampionsTable.COLUMN_MAGIC
            + " TINYINT, "
            + ChampionsTable.COLUMN_DIFFICULTY
            + " TINYINT "
            + ")";

    final String SQL_CREATE_CHAMPION_STATS_TABLE =
        "CREATE TABLE IF NOT EXISTS "
            + ChampionStatsTable.TABLE_NAME
            + " ( "
            + ChampionsTable.COLUMN_NAME
            + " INTEGER, "
            + ChampionStatsTable.COLUMN_STAT_AD
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_ADL
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_ARMOR
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_ARMORL
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_AS
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_ASL
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_CRIT
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_CRITL
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_HP
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_HPL
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_HPR
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_HPRL
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_MP
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_MPL
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_MPR
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_MPRL
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_MR
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_MRL
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_RANGE
            + " DOUBLE, "
            + ChampionStatsTable.COLUMN_STAT_MS
            + " DOUBLE, "
            + " FOREIGN KEY ("
            + ChampionsTable.COLUMN_NAME
            + ") REFERENCES "
    ...
    final String SQL_CREATE_CHAMPION_ABILITY_TABLE =
        "CREATE TABLE IF NOT EXISTS "
            + ChampionAbilityTable.TABLE_NAME
            + " ( "
            + ChampionsTable.COLUMN_NAME
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_Q_NAME
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_Q_DESCRIPTION
            + " TEXT, "
            + ChampionAbilityTable.COLUMN_Q_IMAGE_PATH
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_Q_COOLDOWN_BURN
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_Q_COST_BURN
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_W_NAME
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_W_DESCRIPTION
            + " TEXT, "
            + ChampionAbilityTable.COLUMN_W_IMAGE_PATH
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_W_COOLDOWN_BURN
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_W_COST_BURN
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_E_NAME
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_E_DESCRIPTION
            + " TEXT, "
            + ChampionAbilityTable.COLUMN_E_IMAGE_PATH
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_E_COOLDOWN_BURN
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_E_COST_BURN
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_R_NAME
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_R_DESCRIPTION
            + " TEXT, "
            + ChampionAbilityTable.COLUMN_R_IMAGE_PATH
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_R_COOLDOWN_BURN
            + " TINYTEXT, "
            + ChampionAbilityTable.COLUMN_R_COST_BURN
            + " TINYTEXT, "
            + " FOREIGN KEY ("
            + ChampionsTable.COLUMN_NAME
            + ") REFERENCES "
    ...
    final String SQL_CREATE_ITEM_TABLE =
        "CREATE TABLE IF NOT EXISTS "
            ...
            + " INTEGER, "
            + ItemsTable.COLUMN_STAT_AD
            + " INTEGER, "
            + ItemsTable.COLUMN_STAT_AH
            + " INTEGER, "
            + ItemsTable.COLUMN_STAT_AP
            + " INTEGER, "
            + ItemsTable.COLUMN_STAT_ARMOR
            + " INTEGER, "
            + ItemsTable.COLUMN_STAT_AS
            + " INTEGER, "
            + ItemsTable.COLUMN_STAT_MR
            + " INTEGER, "
            + ItemsTable.COLUMN_STAT_MS
            + " INTEGER "
            + ")";
