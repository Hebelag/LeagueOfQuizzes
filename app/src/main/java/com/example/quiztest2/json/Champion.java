...
public class Champion implements Parcelable {
    ...
    public Champion(int id, String name, String title, String origin, String adaptiveType, String primaryRole, String rangedType, String preferredLane, String releaseDate){
        this.id = id;
        this.name = name;
        this.title = title;
        this.origin = origin;
